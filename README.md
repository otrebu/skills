...
| [`fable-orchestration`](./skills/fable-orchestration) | Enables UltraCode and routes planning, implementation, review, debugging, research, and low-risk mechanical work across Fable 5 XI, Opus 4.8, and Sonnet 5 subagents. |
| [`open-agent-pane`](./skills/open-agent-pane) | Opens a right-hand Herdr pane and briefs Codex, Claude, Cursor Agent, or pi from a focused snapshot of the current conversation. |
